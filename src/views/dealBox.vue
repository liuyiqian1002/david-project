<template>
  <div class="deal_wrap">
    ...
    <div class="select-coins">
      <div @click="test" style="cursor: pointer">
        <span style="color: #fff; margin-right: 5px">{{ title }}</span>
        <van-icon
          :name="require('../assets/images/trade/组 6139.png')"
          size="18"
    ...
    <div class="content">
      <div class="con_left">
        ...
        <div :class="[{ sell: tradType == 1 }, { bay: tradType == 2 }, 'txt']">
          <div class="minus" @click="crtPrice('minus')"><div>-</div></div>
          <div class="in">
            <input type="text" v-model="Price" />
          </div>
          <div class="add" @click="crtPrice('add')"><div>+</div></div>
        </div>
        <div :class="[{ sell: tradType == 1 }, { bay: tradType == 2 }, 'txt']">
          <div class="minus" @click="crtQuantity('min')"><div>-</div></div>
          <div class="in">
            <input
              type="text"
              v-model="Quantity"
          ...
          <div class="add" @click="crtQuantity('add')"><div>+</div></div>
        </div>
        <div class="bot">
      ...
      <div class="con_right">
        ...
        <ul v-for="(i, index) in tradJson.bids" :key="index + getUuid()">
        ...
        <ul v-for="(i, index) in tradJson.asks" :key="index + getUuid()">
    ...
    <div class="record">
      <div class="title">
        <span
          ><img src="../assets/images/trade/组 6058.png" alt="" />
          {{ $t("deal.entrust") }}</span
        >
      ...
      <div class="con">
        ...
        <div
          v-else
          class="card"
          v-for="(i, index) in OrdersPageList"
          :key="index"
        >
          <div>
            <p
    ...
    >
      ...
      <ul class="pwd_num">
        ...
        <li
          class="unent"
          v-for="(i, index) in 6 - Password.length"
          :key="index.toString()"
        ></li>
      </ul>
    </van-dialog>
  ...
  .select-coins {
    ...
    .more_symbols {
      ...
      .more-con {
        ...
        height: 560px;
        overflow-y: scroll;
        background: @panel_color; // linear-gradient( 145deg, #03C1A7 0%, #30AED4 100%);
