  ...
  <div class="trad_wrap">
    ...
    <div class="ifrem_wrap" ref="iframeBox">
      ...
      <div class="coins_info">
        <div class="title">
          <div class="pic">
            <img :src="$config.imgPath + SymbolsData.Icon" alt="" />
          </div>
          <div>
          ...
          <li>
            ...
            <div>
              ...
              <img
                ...
                v-show="SymbolsData.WhitePaper"
                src="../assets/images/common/copy_ico.png"
                alt=""
              />
            </div>
          </li>
          <li>
            ...
            <div>
              ...
              <img
                ...
                v-clipboard:success="onCopy"
                v-clipboard:error="onError"
                v-show="SymbolsData.OfficialWebsite"
                src="../assets/images/common/copy_ico.png"
                alt=""
              />
            </div>
    ...
    <div class="btns" v-show="showBtn">
      <button class="main_btn bay" @click="toDeal(1)">
        {{ $t("base.bay") }}
      </button>
      <button class="main_btn sell" @click="toDeal(2)">
        {{ $t("base.sell") }}
      </button>
    </div>
  </div>
...
export default {
  ...
  mounted() {
    // this.symbolId = this.$route.query.SymbolsId;
    if(this.$route.query.SymbolsId){
      this.getKline(this.$route.query.SymbolsId);
    }
  },
  watch: {
    symbolId(val) {
      val && this.getKline(val);
    },
  },
  methods: {
    getSymbolsEntity() {
    ...
    getKline(symbolId) {
      ...
      this.title = "";
      this.SymbolsIdTiem = localStorage.getItem("SymbolsIdTiem")
      ...
      setTimeout((_) => {
        ...
        this.$refs.iframe.style.height = height - 450 + "px";
