  ...
  <div class="recharge_wrap" style="height: 1000px">
    ...
    <div class="content">
      <div class="service" @click="CustomerService">
        <img
          src="../assets/images/common/ic_contract_service_small.png"
          alt=""
        />
        <div>
          <div>
      ...
      <div class="btns">
        <button class="main_btn" @click="Certificate">
          {{ $t("recharge.confirm") }}
        </button>
      </div>
    </div>
...
import { setToken, getToken, encryptByDES, decryptByDES } from "@/libs/util";
