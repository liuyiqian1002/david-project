  ...
  <div class="buy_coin_content" ref="buy_coin_content">
      <div class="top">
            ...
            class="nav"
                ...
                <template  #left >
                    <van-icon name="arrow-left" v-show="!token" size="20px" color="#ffffff !important" />
                    <!-- <van-icon
                    v-show="!token"
      ...
      submitQuickBuyCoin(){
          ...
          console.log(data)
           this.$toast.loading({
            ...
            //  var r = {data: {"Code":200,"Message":"Successful operation","Data":"https://m.baidu.com?uid=XV876637&platform=Unlte&buy=83.33333333USDT&pay=100USD"}
            //  }
          SubmitQuickBuyCoin(data).then(r=>{
              if(r.data.Code==200){
                ...
                //   {"Code":200,"Message":"Successful operation","Data":"https://m.baidu.com?uid=XV876637&platform=Unlte&buy=83.33333333USDT&pay=100USD"}
              }
