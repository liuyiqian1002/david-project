        ...
        >
          <div class="card_wrap">
            <div
              ...
              @click="Record(i.capitalpoolid)"
              :key="index"
            >
              <div class="pic">
                <div :class="['tag', { dis: i.remainingdays < 0 }]">
                  {{
                    i.remainingdays > 0
                      ? $t("Order.Due") + i.remainingdays + $t("mining.Days")
                      : $t("Order.Expired")
                  }}
                </div>
              ...
              <div class="btns">
                <button @click.stop="toDetail(i.commodityid)">
                  {{ $t("Order.Buyagain") }}
                </button>
              </div>
            </div>
