<template>
  <div class="forget_wrap_box">
    <div class="form-wrapper">
      <forgetPwdBox></forgetPwdBox>
    </div>
  </div>
</template>
...
import forgetPwdBox from "./forgetPwdBox.vue";
export default {
  name: "forget",
  components: {
    // [Sticky.name]: Sticky,
  ...
  methods: {
    ...
    //   let data = {
    //     Account:
    //       this.navIndex == 1 ? this.Email : this.PhoneAre + "|" + this.Phone,
...
.forget_wrap_box {
  ...
  height: 100vh;
  overflow: hidden;
  background: url(../assets/pc/蒙版组 10@3x.png) no-repeat;
