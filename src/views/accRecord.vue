<template>
  <div class="acc_record_wrap">
    ...
    <div class="btns">
      <button @click="toRecharge" class="main_btn">
        {{ $t("property.recharge") }}
      </button>
      <button
        :disabled="coinInfo.IsWithdraw != 1"
        @click="$router.push('/withdraw_coin')"
        class="main_btn"
      >
        {{ $t("property.withdraw") }}
      </button>
...
<script>
import { Icon, NavBar, IndexBar, List, empty, Image } from "vant";
...
.acc_record_wrap {
  ...
  .top {
    ...
    z-index: 10;
    > .title {
      background: url(../assets/images/common/circlebg.png) no-repeat center;
      font-size: 32px;
      font-weight: 500;
      height: 120px;
      line-height: 120px;
    ...
    .acc_info {
      ...
      .main_r {
        ...
        button {
          ...
          height: 60px;
          border-radius: 4px;
          // border: 1px solid @font_4_color;/* px */
          font-weight: 600; /* px */
          margin: 30px 0;
  ...
  .contnet {
    ...
    .card {
      ...
      margin-bottom: 20px;
      // border-bottom: 1px solid @font_4_color;/* px */
      // padding: 20px;
