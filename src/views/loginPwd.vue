<template>
  <div class="login_pwd_wrap_main">
    ...
    <div class="login_pwd_wrap">
        ...
        <ul>
          <li>
            <input
              ...
              :placeholder="$t('loginPwd.newPws1')"
            />
          </li>
        </ul>
      </div>
      ...
      <div class="btns">
        <button class="main_btn" @click="updatePassword">
          {{ $t("loginPwd.btn") }}
        </button>
      </div>
    </div>
